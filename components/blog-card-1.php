<div class="col-lg-4 col-md-6 portfolio-item filter-app">
  <div class="portfolio-wrap">
    ...
    <div class="portfolio-info px-3 py-4">
      ...
      <p class="overflow-auto"><?php echo $description; ?></p>
      <div class="portfolio-links">
        <a class="portfolio-details-lightbox" data-gallery="blogGallery" href="#<?php echo $id; ?>"><i
            class="bx bx-link"></i></a>
        <a href="<?php echo $url; ?>"><i class="bx bx-link"></i></a>
      </div>
    </div>
  </div>
