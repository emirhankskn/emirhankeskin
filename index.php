...
<head>
  ...
  <title>Ahmet Emirhan Keskin</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/faviconNew.png" rel="icon">
  <link href="assets/img/faviconNew.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="overflow-hidden">
    <div class="container">
      <div class="" style="background: #00000091;
    padding: 12px 16px;
    border-radius: 7px;
    width: fit-content;">
  ...
  <div class="credits">
    Developed by <a href="https://bootstrapmade.com/">A.Emirhan Keskin</a>
  </div>
